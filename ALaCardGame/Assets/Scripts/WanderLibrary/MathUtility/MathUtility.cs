...
namespace WanderMath
{
    public static class MathUtility
    {
        ...
        public static Vector3 SinWavePos(float normalizedTime, Vector3 originalPos,Vector3 direction, float sinMultiplier)
        {
            float sinWaveVal = Mathf.Sin(TAU * normalizedTime);

            return originalPos + direction * (sinMultiplier * sinWaveVal);
        }
        ...
        public static Vector3 RandomVector3(Vector2 randomRangeX,Vector2 randomRangeY, Vector2 randomRangeZ)
        {
            return new Vector3(Random.Range(randomRangeX.x, randomRangeX.y),
